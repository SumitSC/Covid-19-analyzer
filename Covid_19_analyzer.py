...
create_secondwindow1.minsize(1600,1000)
create_secondwindow1.title("SVASTHYA APP")

fram1= Frame(create_secondwindow1,width=50,height=50)
...
img = ImageTk.PhotoImage(Image.open("Sumit.jpg"))
